...
const TARGETS = [
  ...
  { name: 'Tulane University of Louisiana', url: 'https://admission.tulane.edu/apply' },
  { name: 'University of Richmond', url: 'https://admission.richmond.edu/apply' },
  { name: 'Elon University', url: 'https://www.elon.edu/apply' },
  { name: 'Furman University', url: 'https://www.furman.edu/apply' },
  { name: 'Occidental College', url: 'https://www.oxy.edu/apply' },
  { name: 'University of Puget Sound', url: 'https://www.pugetsound.edu/apply' },
  { name: 'Whitman College', url: 'https://www.whitman.edu/apply' },
  { name: 'Reed College', url: 'https://www.reed.edu/apply' },
  { name: 'Denison University', url: 'https://www.denison.edu/apply' },
  { name: 'Skidmore College', url: 'https://www.skidmore.edu/admissions' },
  { name: 'Franklin and Marshall College', url: 'https://www.fandm.edu/apply' },
  { name: 'Gettysburg College', url: 'https://www.gettysburg.edu/apply' },
  { name: 'Dickinson College', url: 'https://www.dickinson.edu/apply' },
  { name: 'Muhlenberg College', url: 'https://www.muhlenberg.edu/apply' },
  { name: 'St Olaf College', url: 'https://wp.stolaf.edu/admissions' },
