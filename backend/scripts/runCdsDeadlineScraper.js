...
// Runner for the Common Data Set deadline scraper.
//   node scripts/runCdsDeadlineScraper.js --dry-run
//   node scripts/runCdsDeadlineScraper.js
// Exits non-zero if the success-gate fails (no NEW deadlines added).

const fs = require('fs');
const path = require('path');
const { Pool } = require('pg');
const { runScrapers } = require('../src/scrapers/scraperFramework');
const { adapter } = require('../src/scrapers/adapters/commonDataSetDeadlines');
