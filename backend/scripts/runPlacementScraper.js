...
// Runner for the institution placements scraper.
//   node scripts/runPlacementScraper.js --dry-run
//   node scripts/runPlacementScraper.js
// Requires migration 119 (canonical.institution_placements) to be applied.
...
const { adapter } = require('../src/scrapers/adapters/institutionPlacements');
