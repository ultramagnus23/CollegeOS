...
def _normalise(record: dict) -> dict:
    ...
    return {
        ...
        "applicants_total": _safe(record, "latest.admissions.applicants.total"),
        "admitted_total": _safe(record, "latest.admissions.admitted.total"),
        "enrolled_total": _safe(record, "latest.student.enrollment.all"),
        "median_sat_25": sat_25,
        "median_sat_75": sat_75,
        "sat_verbal_25": _safe(record, "latest.admissions.sat_scores.25th_percentile.critical_reading"),
        "sat_verbal_75": _safe(record, "latest.admissions.sat_scores.75th_percentile.critical_reading"),
        "sat_math_25": _safe(record, "latest.admissions.sat_scores.25th_percentile.math"),
        "sat_math_75": _safe(record, "latest.admissions.sat_scores.75th_percentile.math"),
        "sat_total_25": sat_25,
        "sat_total_75": sat_75,
