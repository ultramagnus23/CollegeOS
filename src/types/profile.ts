...
export const canonicalProfileSchema = z.object({
  ...
  phone: z.preprocess((v) => (v == null ? '' : v), z.string().max(30)).default(''),
  dateOfBirth: z.preprocess((v) => (v == null ? '' : v), z.string().max(20)).default(''),
  ...
  curriculumTypeOther: z.preprocess((v) => (v == null ? '' : v), z.string().max(100)).default(''),
